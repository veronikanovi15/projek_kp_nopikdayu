        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{ route('kunjungan.store') }}" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="tgl_kunjungan" name="tgl_kunjungan" value="{{ old('tanggal_kunjungan') }}">
                    </div>
                </div>
              <div class="form-group row">
                  <label for="nama" class="col-sm-2 col-form-label">Pengunjung</label>
                  <div class="col-sm-10">
              ...
              <div class="form-group row">
                  <label for="nama" class="col-sm-2 col-form-label">Penerima</label>
                  <div class="col-sm-10">
